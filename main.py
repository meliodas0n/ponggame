...
def draw_object():
    ...
    pygame.draw.circle(screen, WHITE, (int(ball_x), int(ball_y)), int(ball_width))
...
def apply_ball_movement():
    ...
    if (ball_x + ball_x_vel < p1_x_pos + paddle_width) and (p1_y_pos < ball_y + ball_y_vel + ball_width < p1_y_pos + paddle_height):
    ...
    if (ball_x + ball_x_vel > p2_x_pos - paddle_width) and (p2_y_pos < ball_y + ball_y_vel + ball_width < p2_y_pos + paddle_height):
        ball_x_vel = -ball_x_vel
